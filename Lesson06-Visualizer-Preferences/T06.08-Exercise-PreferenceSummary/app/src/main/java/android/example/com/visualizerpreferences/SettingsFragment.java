...
public class SettingsFragment extends PreferenceFragmentCompat implements OnSharedPreferenceChangeListener {
    ...
    public void onCreatePreferences(Bundle bundle, String s) {
        ...
        for (int i = 0; i < preferenceScreen.getPreferenceCount(); i++){
            if (preferenceScreen.getPreference(i) instanceof ListPreference) {
                setPreferenceSummary(preferenceScreen.getPreference(i), ((ListPreference) preferenceScreen.getPreference(i)).getValue());
            }
        }
    }
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String s) {
        if(getPreferenceScreen().findPreference(s) instanceof ListPreference ){
            setPreferenceSummary(getPreferenceScreen().findPreference(s), ((ListPreference) getPreferenceScreen().findPreference(s)).getValue());
        }
    }
